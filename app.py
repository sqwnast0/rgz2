                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{p.name}</td>
                                <td>
                                    <span class="{'quantity-low' if p.quantity <= 5 else 'quantity-ok'}">
                                        <i class="fas {'fa-exclamation-triangle' if p.quantity <= 5 else 'fa-check-circle'}"></i>
                                        {p.quantity} шт.
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="order-status {'status-paid' if order.is_paid else 'status-unpaid'}">
                                        <i class="fas {'fa-check-circle' if order.is_paid else 'fa-times-circle'}"></i>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px;">
                    ...
                    <div class="product-card" onclick="addToCart({p.id})" style="cursor: pointer;">
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 15px;">
                            ...
                            <div class="{'quantity-low' if p.quantity <= 5 else 'quantity-ok'}" style="font-size: 14px;">
                                <i class="fas {'fa-exclamation-triangle' if p.quantity <= 5 else 'fa-box'}"></i> {p.quantity} шт.
                            </div>
                        </div>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; gap: 20px;">
                            <div style="flex: 1;">
                                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                                    ...
                                    <span class="order-status {'status-paid' if order.is_paid else 'status-unpaid'}" style="font-size: 12px;">
                                        <i class="fas {'fa-check-circle' if order.is_paid else 'fa-times-circle'}"></i>
                                        {'Оплачен' if order.is_paid else 'Не оплачен'}
                                    </span>
                                </div>
